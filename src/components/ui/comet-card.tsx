...
export const CometCard = ({
  ...
  const glareBackground = useMotionTemplate`radial-gradient(circle at ${glareX}% ${glareY}%, rgb(var(--comet-glare-rgb) / var(--comet-glare-1)) 10%, rgb(var(--comet-glare-rgb) / var(--comet-glare-2)) 20%, rgb(var(--comet-glare-rgb) / 0) 80%)`;
  ...
  return (
    <div className={cn("perspective-distant transform-3d", className)}>
      <motion.div
        ...
        className="relative rounded-2xl comet-shadow"
      >
        {children}
        <motion.div
          ...
          style={{
            ...
            opacity: "var(--comet-glare-opacity)",
          }}
          transition={{ duration: 0.2 }}
        />
      </motion.div>
