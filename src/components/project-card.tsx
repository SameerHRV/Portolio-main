...
import { Github, Globe, ExternalLink, Eye } from 'lucide-react';
  ...
  return (
    <Card className="group relative h-full overflow-hidden rounded-2xl border-0 bg-card/50 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 card-hover">
      ...
      <CardContent className="flex flex-1 flex-col p-6">
        ...
        <p className="flex-1 text-muted-foreground text-sm leading-relaxed mb-4">
          {description}
        </p>
        ...
        <div className="mb-4">
          <SuggestionDialog
            ...
            onSuggestionSelect={setDescription}
          />
        </div>
      </CardContent>
      
      <CardFooter className="flex justify-between p-6 pt-0">
        <Button asChild variant="ghost" size="sm" className="group/btn hover:bg-primary hover:text-primary-foreground transition-all duration-300">
